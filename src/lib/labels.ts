...
export const auditActionLabels: Labels = { INSERT: 'สร้าง', CREATE: 'สร้าง', UPDATE: 'แก้ไข', DELETE: 'ลบ', CONFIRM: 'ยืนยัน', ACTIVATE: 'เปิดใช้งาน', DEACTIVATE: 'ปิดการใช้งาน', CLOSE_SHORT: 'ปิดแบบรับไม่ครบ', REOPEN_AFTER_RECEIPT_REVERSAL: 'เปิด Invoice ใหม่หลังยกเลิกรายการ', PROVISION: 'ตั้งค่าผู้ใช้', BOOTSTRAP_ADMIN: 'สร้างผู้ดูแลคนแรก', REVISE: 'แก้ไขผลตรวจรับ', ANNUAL_DRAFT_CREATED: 'สร้างฉบับร่างรายงานประจำปี', ANNUAL_FINALIZED: 'สิ้นสุดรายงานประจำปี', POLICY_PROPOSAL_SAVED: 'บันทึกข้อเสนอนโยบาย', POLICY_APPROVED: 'อนุมัตินโยบาย', SIGNATURE_SAVED: 'บันทึกลายเซ็น', POSITION_SET: 'กำหนดตำแหน่ง', QR_ROTATE: 'เปลี่ยน QR ตำแหน่ง' };
export const entityTableLabels: Labels = {
  ...
  ci_stock_transactions: 'ธุรกรรมสต็อก', ci_stock_lots: 'LOT', ci_stock_counts: 'ตรวจนับ', ci_locations: 'ตำแหน่ง', ci_location_env_configs: 'ช่วงอุณหภูมิ/ความชื้นของตำแหน่ง', ci_reorder_settings: 'ตั้งค่า ROP',
