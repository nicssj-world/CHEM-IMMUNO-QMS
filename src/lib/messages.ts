...
const codeMessages: Record<string, string> = {
  ...
  CI_CONFIRMED_HISTORY_IMMUTABLE: 'รายการที่ยืนยันแล้วแก้ไขไม่ได้ · ใช้การย้อนรายการแทน',
  ...
  CI_REVERSAL_REASON_REQUIRED: 'กรุณาระบุเหตุผลการย้อนรายการ',
  CI_REVERSAL_SOURCE_INVALID: 'ย้อนรายการนี้ไม่ได้',
